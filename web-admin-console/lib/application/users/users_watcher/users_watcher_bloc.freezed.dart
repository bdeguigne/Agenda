...
// ignore: unused_element
  UsersReceived usersReceived(
      Either<RepositoryFailure, List<User>> failureOrUsers) {
...
mixin _$UsersWatcherEvent {
  ...
  TResult when<TResult extends Object>({
    ...
    @required
        TResult usersReceived(
            Either<RepositoryFailure, List<User>> failureOrUsers),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult watchAll(),
    TResult usersReceived(Either<RepositoryFailure, List<User>> failureOrUsers),
...
abstract class $UsersReceivedCopyWith<$Res> {
  ...
  $Res call({Either<RepositoryFailure, List<User>> failureOrUsers});
}
  ...
  $Res call({
    ...
    return _then(UsersReceived(
      failureOrUsers == freezed
          ...
          : failureOrUsers as Either<RepositoryFailure, List<User>>,
    ));
  }
}
...
class _$UsersReceived implements UsersReceived {
  ...
  @override
  final Either<RepositoryFailure, List<User>> failureOrUsers;
...
abstract class UsersReceived implements UsersWatcherEvent {
  const factory UsersReceived(
      Either<RepositoryFailure, List<User>> failureOrUsers) = _$UsersReceived;

  Either<RepositoryFailure, List<User>> get failureOrUsers;
  @JsonKey(ignore: true)
  $UsersReceivedCopyWith<UsersReceived> get copyWith;
}
