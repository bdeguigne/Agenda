...
import 'application/users_watcher/users_watcher_bloc.dart' as _i10;
import 'domain/auth/i_auth_facade.dart' as _i5;
import 'domain/users/i_users_repository.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i7.IUsersRepository>(
      () => _i8.UsersRepository(get<_i4.FirebaseFirestore>()));
  gh.factory<_i9.SignInFormBloc>(
      () => _i9.SignInFormBloc(get<_i5.IAuthFacade>()));
  gh.factory<_i10.UsersWatcherBloc>(
      () => _i10.UsersWatcherBloc(get<_i7.IUsersRepository>()));
